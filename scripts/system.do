...
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/rif/ex_mem_out.pc4
...
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/rif/ex_mem_out.zero
...
add wave -noupdate /system_tb/DUT/CPU/DP/hu/predict_taken
add wave -noupdate /system_tb/DUT/CPU/DP/hu/branch_taken
add wave -noupdate -expand -group btb -expand /system_tb/DUT/CPU/DP/btb/buffer
add wave -noupdate -expand -group btb /system_tb/DUT/CPU/DP/btbif/rsel
add wave -noupdate -expand -group btb -childformat {{/system_tb/DUT/CPU/DP/btbif/wsel.ind -radix unsigned}} -expand -subitemconfig {/system_tb/DUT/CPU/DP/btbif/wsel.ind {-radix unsigned}} /system_tb/DUT/CPU/DP/btbif/wsel
add wave -noupdate -expand -group btb -expand /system_tb/DUT/CPU/DP/btbif/rdat
...
add wave -noupdate -expand -group btb /system_tb/DUT/CPU/DP/btbif/phit
add wave -noupdate -expand -group btb /system_tb/DUT/CPU/DP/mem_opcode
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1698207 ps} 0}
...
update
WaveRestoreZoom {1686 ns} {2529 ns}
